...
public class ConfirmAndRejectSHAConversion {
	...
	public static void main(String[] args) {
		...
		try {
			String requestId = "REQ1006202602";
			String auth_id = "TPSM000091";
			double amount = 99.98; // Always keep amount in 2 decimal format
			...
			String checksumString = requestId + auth_id + String.format("%.2f", amount) + payer_addr + payee_addr;
